/* Source for app.js — edit here, then run: npm run build */
    ...
    /* ── Helpers ── */
    function getDaysUntil(ds) { if(!ds)return null; const v=Math.ceil((new Date(ds+"T23:59:59")-new Date(TODAY_STR+"T00:00:00"))/86400000); return isNaN(v)?null:v; }
    ...
    /* ── Map Component ── */
    // Helper to get coords from location string (city name or "City, Country")
    const LOC_MAP={
      "Atlanta":[33.7490,-84.3880],"London":[51.5074,-0.1278],"New York":[40.7128,-74.0060],"Chicago":[41.8781,-87.6298],
      "Frankfurt":[50.1109,8.6821],"Paris":[48.8566,2.3522],"Singapore":[1.3521,103.8198],"Hong Kong":[22.3193,114.1694],
      "Toronto":[43.6532,-79.3832],"Seoul":[37.5665,126.9780],"Sydney":[-33.8688,151.2093],"Tokyo":[35.6762,139.6503],
      "Amsterdam":[52.3676,4.9041],"Zurich":[47.3769,8.5417],"Edinburgh":[55.9533,-3.1883],"Milan":[45.4642,9.1900],
      "Washington DC":[38.9072,-77.0369],"Boston":[42.3601,-71.0589],"Philadelphia":[39.9526,-75.1652],"Nashville":[36.1627,-86.7816],
      "Dallas":[32.7767,-96.7970],"Denver":[39.7392,-104.9903],"Helsinki":[60.1695,24.9354],"Copenhagen":[55.6761,12.5683],
      "Stockholm":[59.3293,18.0686],"Barcelona":[41.3851,2.1734],"Madrid":[40.4168,-3.7038],"Vienna":[48.2082,16.3738],
      "Brussels":[50.8503,4.3517],"Dublin":[53.3498,-6.2603],"Prague":[50.0755,14.4378],"Munich":[48.1351,11.5820],
      "Hanoi":[21.0285,105.8542],"Shanghai":[31.2304,121.4737],"Shenzhen":[22.5431,114.0579],"Brisbane":[-27.4698,153.0251],
      "Melbourne":[-37.8136,144.9631],"San Francisco":[37.7749,-122.4194],"Los Angeles":[34.0522,-118.2437],"Seattle":[47.6062,-122.3321],
      "Miami":[25.7617,-80.1918],"Austin":[30.2672,-97.7431],"Houston":[29.7604,-95.3698],"Phoenix":[33.4484,-112.0740],
      "San Diego":[32.7157,-117.1611],"Vancouver":[49.2827,-123.1207],"Montreal":[45.5017,-73.5673],"Berlin":[52.5200,13.4050],
      "Hamburg":[53.5511,9.9937],"Rome":[41.9028,12.4964],"Lisbon":[38.7223,-9.1393],"Warsaw":[52.2297,21.0122],
      "Budapest":[47.4979,19.0402],"Athens":[37.9838,23.7275],"Istanbul":[41.0082,28.9784],"Dubai":[25.2048,55.2708],
      "Bangkok":[13.7563,100.5018],"Kuala Lumpur":[3.1390,101.6869],"Taipei":[25.0330,121.5654],"Beijing":[39.9042,116.4074],
      "Osaka":[34.6937,135.5023],"Auckland":[-36.8485,174.7633],"Cape Town":[-33.9249,18.4241],"Sao Paulo":[-23.5505,-46.6333],
      "Mexico City":[19.4326,-99.1332],"Oslo":[59.9139,10.7522],"Geneva":[46.2044,6.1432],"Luxembourg":[49.6116,6.1319],
      "Oxford":[51.7520,-1.2577],"Cambridge":[52.2053,0.1218],"Rotterdam":[51.9244,4.4777],"Manchester":[53.4808,-2.2426],
      "San Antonio":[29.4241,-98.4936],"Honolulu":[21.3069,-157.8583],"New Orleans":[29.9511,-90.0715],"Tel Aviv":[32.0853,34.7818]
    };

    // Additional city aliases for locations that don't match directly
    const CITY_ALIASES={"Washington, DC":"Washington DC","Washington, D.C.":"Washington DC","Washington DC, USA":"Washington DC",
      "Hong Kong SAR":"Hong Kong","Hong Kong, China":"Hong Kong","Honolulu":"Honolulu","Big Island, Hawaii":"Honolulu",
      "St. Louis, MO":"St. Louis","St. Louis":"St. Louis","Durham, United Kingdom":"Durham UK","Durham, UK":"Durham UK",
      "Chapel Hill, NC":"Chapel Hill","Chapel Hill":"Chapel Hill","Ann Arbor, Michigan":"Ann Arbor","Ann Arbor":"Ann Arbor",
      "Scottsdale, Arizona":"Phoenix","Scottsdale":"Phoenix","Evanston, IL":"Chicago","Storrs, CT":"Hartford",
      "Newark, Delaware":"Philadelphia","Villanova, PA":"Philadelphia","State College, PA":"Pittsburgh",
      "Clemson, SC":"Atlanta","Tallahassee":"Miami","Asheville, NC":"Atlanta","Palm Springs":"Los Angeles",
      "Bretton Woods":"Boston","San Destin, Fl":"Miami","Vail, Colorado":"Denver","Boulder, Colorado":"Denver",
      "ESSEC":"Paris","Stanford":"San Francisco","Yale":"New York","Duke University":"Durham NC",
      "Loyola University Maryland":"Baltimore","Rutgers":"New York","Darden":"Charlottesville",
      "University of North Carolina":"Chapel Hill","University of Kentucky":"Lexington",
      "Krea University":"Chennai","Alicante":"Barcelona","Zion National Park":"Las Vegas",
      "Saariselkä":"Helsinki","Lapland":"Helsinki","Arlington, VA":"Washington DC","Arlington":"Washington DC",
      "Limoges":"Paris","Düsseldorf":"Frankfurt","Montclair":"New York","Durham, NH":"Boston",
      "Baltimore":"Baltimore","Las Vegas":"Las Vegas","Tampa":"Miami","Ayia Napa":"Athens",
      "St. Kitts":"Miami","Meath":"Dublin","JW Marriott":"Washington DC","Azores":"Lisbon",
      "Ghent":"Brussels","Nice":"Nice","Mannheim":"Frankfurt","Eltville am Rhein":"Frankfurt","Halle":"Berlin",
      "Hagen":"Berlin","Siegen":"Frankfurt","Odense":"Copenhagen","Lund":"Stockholm","Liège":"Brussels",
      "Limerick":"Dublin","Cagliari":"Rome","Padua":"Milan","Pavia":"Milan","Naples":"Naples","Capri":"Naples",
      "Turin":"Turin","Florence":"Florence","Braga":"Lisbon","Krakow":"Warsaw","Marseille":"Marseille",
      "Toulouse":"Paris","Clermont-Ferrand":"Paris","Windermere":"Manchester","Bristol":"Bristol","Lancaster":"Manchester",
      "Exeter":"London","Garmisch-Partenkirchen":"Munich","Bern":"Geneva","Lausanne":"Geneva","Weggis":"Zurich",
      "Saas-Fee":"Geneva","Gerzensee":"Geneva","Ischgl":"Vienna","Zakynthos":"Athens","Crete":"Athens","Chania":"Athens",
      "Bali":"Jakarta","Danang":"Hanoi","Busan":"Seoul","Sharjah":"Dubai","Bahrain":"Dubai",
      "Niagara Falls":"Toronto","Quebec City":"Montreal","Whistler":"Vancouver","Edmonton":"Vancouver","Banff":"Vancouver",
      "College Station":"Dallas","Amherst":"Boston","Notre Dame":"Chicago","Vaduz":"Zurich","Sardinia":"Rome",
      "Sophia Antipolis":"Nice","Tilburg":"Amsterdam","Maastricht":"Amsterdam","Rotterdam":"Rotterdam"};
    // Extra cities not in LOC_MAP
    const EXTRA_COORDS={"Durham UK":[54.7753,-1.5849],"Chapel Hill":[35.9132,-79.0558],"Ann Arbor":[42.2808,-83.7430],
      "St. Louis":[38.6270,-90.1994],"Nice":[43.7102,7.2620],"Naples":[40.8518,14.2681],"Turin":[45.0703,7.6869],
      "Florence":[43.7696,11.2558],"Marseille":[43.2965,5.3698],"Bristol":[51.4545,-2.5879],"Hartford":[41.7658,-72.6734],
      "Pittsburgh":[40.4406,-79.9959],"Jakarta":[-6.2088,106.8456],"Taipei":[25.0330,121.5654],"Chennai":[13.0827,80.2707],
      "Tallinn":[59.4370,24.7536],"Santiago":[-33.4489,-70.6693],
      "Durham NC":[35.9940,-78.8986],"Baltimore":[39.2904,-76.6122],"Charlottesville":[38.0293,-78.4767],
      "Lexington":[38.0406,-84.5037],"Las Vegas":[36.1699,-115.1398]};

    function getCoords(loc){
      if(!loc)return null;
      // 1. Exact match
      if(LOC_MAP[loc])return LOC_MAP[loc];
      // 2. Check aliases
      for(const[alias,city] of Object.entries(CITY_ALIASES)){
        if(loc.includes(alias)){
          if(LOC_MAP[city])return LOC_MAP[city];
          if(EXTRA_COORDS[city])return EXTRA_COORDS[city];
        }
      }
      // 3. Split by comma, check each part
      const parts=loc.split(",").map(p=>p.trim());
      for(const p of parts){
        if(LOC_MAP[p])return LOC_MAP[p];
        if(EXTRA_COORDS[p])return EXTRA_COORDS[p];
      }
      // 4. Search for any known city name within the full string
      const locLower=loc.toLowerCase();
      for(const[city,coords] of Object.entries(LOC_MAP)){
        if(city.length>3&&locLower.includes(city.toLowerCase()))return coords;
      }
      for(const[city,coords] of Object.entries(EXTRA_COORDS)){
        if(city.length>3&&locLower.includes(city.toLowerCase()))return coords;
      }
      return null;
    }
    ...
    function MapView({conferences,T,isDark}){
      ...
      useEffect(()=>{
        ...
        if(!mapInstance.current){
          ...
          L.control.attribution({position:"bottomright",prefix:false}).addAttribution('&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>').addTo(mapInstance.current);
        ...
        tileLayer.current=L.tileLayer(tileUrl,{subdomains:"abcd",maxZoom:19}).addTo(map);

        markerGroup.current.clearLayers();

        const clusters={};
        conferences.forEach(c=>{
          if(!c.location||c.location==="Virtual"||c.location==="TBD"||c.location.includes("Virtual"))return;
          const coords=getCoords(c.location);
          if(!coords)return;
          const k=coords.join(",");
          if(!clusters[k])clusters[k]={coords,confs:[]};
          clusters[k].confs.push(c);
        });

        Object.values(clusters).forEach(({coords,confs})=>{
          const discCounts={fin:0,acct:0,econ:0,multi:0};
          confs.forEach(c=>c.disc.forEach(d=>{if(discCounts[d]!==undefined)discCounts[d]++;else discCounts.multi++;}));
          
          let color="#a855f7"; // purple (mixed/multi)
          const total=confs.length;
          // Simple majority logic
          if(discCounts.fin===total)color="#3b82f6"; // blue
          else if(discCounts.acct===total)color="#10b981"; // green
          else if(discCounts.econ===total)color="#f59e0b"; // orange

          const radius=Math.max(6,Math.min(25,6+Math.sqrt(total)*3));
          
          const m=L.circleMarker(coords,{radius,fillColor:color,color:"#fff",weight:1,opacity:0.9,fillOpacity:0.75});
          
          const popupContent=`
            <div style="font-family:'Newsreader',serif;min-width:200px;color:#333">
              <div style="font-weight:700;margin-bottom:6px;border-bottom:1px solid #eee;padding-bottom:4px;font-size:13px">
                ${confs[0].location} (${total})
              </div>
              <div style="max-height:200px;overflow-y:auto">
                ${confs.map(c=>`
                  <div style="margin-bottom:8px;font-size:11px;line-height:1.35;border-bottom:1px dashed #eee;padding-bottom:4px">
                    <div style="font-weight:600;color:#111;margin-bottom:1px"><a href="${c.url||c.ssrnLink}" target="_blank" style="text-decoration:none;color:inherit">${c.name}</a></div>
                    <div style="color:#666;font-family:'JetBrains Mono',monospace;font-size:10px">${c.dates}</div>
                    <div style="color:${c.deadline&&!c.deadline.includes("TBD")?"#d32f2f":"#666"};font-size:10px">DL: ${c.deadline||"TBD"}</div>
                  </div>
                `).join('')}
              </div>
            </div>`;
    ...
    /* Discipline & region colors — adjusted per theme for readability */
    ...
    function UpdateBanner({ T, isDark }) {
      ...
      return (
        <div className={`update-banner ${isDark ? 'dark' : 'light'}`}>
          <span>
            ✨ <strong>New:</strong> Travel cost estimates, calendar integration (Google, Outlook, Apple), and conference comparison tool now available!
          </span>
    ...
    /* ── Card component ── */
    function CalendarDropdown({conf, T, isDark}) {
      ...
      function getGoogleUrl() {
        const start = conf.startDate ? conf.startDate.replace(/-/g, "") : "";
        const startObj = new Date(conf.startDate);
        const endObj = new Date(startObj); endObj.setDate(endObj.getDate() + 1);
        const end = endObj.toISOString().split("T")[0].replace(/-/g, "");
        const details = `Deadline: ${conf.deadline || "TBD"}\nSSRN: ${conf.ssrnLink || ""}\nWebsite: ${conf.url || "N/A"}`;
        return `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(conf.name)}&dates=${start}/${end}&location=${encodeURIComponent(conf.location + ", " + conf.country)}&details=${encodeURIComponent(details)}`;
      }
      ...
      function getOutlookUrl() {
        ...
        const details = `Deadline: ${conf.deadline || "TBD"}\nSSRN: ${conf.ssrnLink || ""}\nWebsite: ${conf.url || "N/A"}`;
        return `https://outlook.live.com/calendar/0/action/compose?subject=${encodeURIComponent(conf.name)}&startdt=${start}&enddt=${end}&location=${encodeURIComponent(conf.location + ", " + conf.country)}&body=${encodeURIComponent(details)}&allday=true`;
      }

      const btnStyle = {display:"flex",alignItems:"center",gap:6,padding:"6px 10px",fontSize:11,color:T.text,background:"transparent",border:"none",cursor:"pointer",width:"100%",borderRadius:4,fontFamily:"'JetBrains Mono',monospace"};
      const hoverBg = isDark ? "rgba(255,255,255,0.07)" : "rgba(0,0,0,0.05)";

      return (
        <div ref={ref} style={{marginLeft:"auto",position:"relative"}} onClick={e=>e.stopPropagation()}>
          <button onClick={()=>setOpen(!open)}
            style={{display:"inline-flex",alignItems:"center",gap:5,padding:"5px 11px",borderRadius:5,background:isDark?"rgba(255,255,255,0.05)":"rgba(0,0,0,0.04)",color:T.textMuted,fontSize:10,fontWeight:500,border:"1px solid "+(T.btnBorder||T.cardBorder),cursor:"pointer",fontFamily:"'JetBrains Mono',monospace"}}>
            📅 Add to Calendar <span style={{fontSize:8}}>▾</span>
          </button>
          {open && (
            <div style={{position:"absolute",right:0,top:"100%",marginTop:4,zIndex:100,minWidth:180,background:isDark?"#1a1f2e":"#fff",border:"1px solid "+T.cardBorder,borderRadius:8,boxShadow:"0 8px 16px rgba(0,0,0,0.25)",overflow:"hidden"}}>
              <a href={getGoogleUrl()} target="_blank" rel="noopener noreferrer" style={{...btnStyle,textDecoration:"none"}}
                onMouseEnter={e=>e.currentTarget.style.background=hoverBg} onMouseLeave={e=>e.currentTarget.style.background="transparent"}>
                📅 Google Calendar
              </a>
              <a href={getOutlookUrl()} target="_blank" rel="noopener noreferrer" style={{...btnStyle,textDecoration:"none"}}
                onMouseEnter={e=>e.currentTarget.style.background=hoverBg} onMouseLeave={e=>e.currentTarget.style.background="transparent"}>
                📧 Outlook
              </a>
              <button onClick={()=>{handleExportOne(conf);setOpen(false);}} style={btnStyle}
                onMouseEnter={e=>e.currentTarget.style.background=hoverBg} onMouseLeave={e=>e.currentTarget.style.background="transparent"}>
                🍎 Apple Calendar
              </button>
            </div>
          ...
          {expanded&&(
            <div style={{padding:"0 16px 13px",borderTop:"1px solid "+T.divider,paddingTop:13}}>
                ...
                <div style={{marginBottom:16,padding:"10px 12px",borderRadius:8,background:isDark?"rgba(16,185,129,0.06)":"rgba(16,185,129,0.04)",border:"1px solid "+(isDark?"rgba(16,185,129,0.15)":"rgba(16,185,129,0.1)")}}>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                    <div>
                      ...
                      <div style={{fontSize:9,color:T.textDim,marginTop:1}}>Hotel: ${travel.hotel_max} · Meals: ${travel.meals}</div>
                    </div>
              ...
              <div style={{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap"}}>
                ...
                <CalendarDropdown conf={conf} T={T} isDark={isDark} />
              </div>
            </div>
          )}
        </div>
    ...
    function App(){
      ...
      const[showAddedToday,setShowAddedToday]=useState(true);
      ...
      useEffect(()=>{
        Promise.all([
          fetch(JSON_URL+"?v="+TODAY_STR).then(r=>{if(!r.ok)throw new Error("HTTP "+r.status);return r.json();}),
          fetch(TRAVEL_JSON_URL+"?v="+TODAY_STR).then(r=>{if(r.ok)return r.json();return null;}).catch(()=>null)
        ])
          .then(([data, tData])=>{
      ...
      const recentlyAdded=useMemo(()=>conferences.filter(c=>c.dateAdded===TODAY_STR).sort((a,b)=>a.name.localeCompare(b.name)),[conferences]);
      const WEEK_AGO_STR=useMemo(()=>{const d=new Date(TODAY);d.setDate(d.getDate()-7);return d.toISOString().split("T")[0];},[]);
      const addedThisWeek=useMemo(()=>conferences.filter(c=>c.dateAdded&&c.dateAdded!==TODAY_STR&&c.dateAdded>=WEEK_AGO_STR).sort((a,b)=>b.dateAdded.localeCompare(a.dateAdded)||a.name.localeCompare(b.name)),[conferences,WEEK_AGO_STR]);
      const upcoming=useMemo(()=>conferences.filter(c=>{const d=getDaysUntil(c.startDate);return d!==null&&d>=0;}),[conferences]);
      const datesTBD=useMemo(()=>conferences.filter(c=>getDaysUntil(c.startDate)===null),[conferences]);
      const pastConfs=useMemo(()=>conferences.filter(c=>{const d=getDaysUntil(c.startDate);return d!==null&&d<0;}).sort((a,b)=>new Date(b.startDate)-new Date(a.startDate)),[conferences]);
      ...
      const filteredTBD=useMemo(()=>{
        let r=datesTBD;
        if(discFilter!=="all")r=r.filter(c=>c.disc.includes(discFilter));
        if(search){const s=search.toLowerCase();r=r.filter(c=>c.name.toLowerCase().includes(s)||c.location.toLowerCase().includes(s)||c.country.toLowerCase().includes(s));}
        return r;
      },[datesTBD,discFilter,search]);
      ...
      if(loading)return(<div style={{minHeight:"100vh",background:T.bg,display:"flex",alignItems:"flex-start",justifyContent:"center",paddingTop:120}}><div style={{color:"#818cf8",fontSize:14,fontFamily:"'JetBrains Mono',monospace"}}>Loading conferences…</div></div>);
        ...
        <div style={{minHeight:"100vh",background:T.bg,color:T.text,fontFamily:"'Newsreader','Georgia','Times New Roman',serif",transition:"background 0.3s ease, color 0.3s ease"}}>
          ...
          <div style={{padding:"30px 20px 22px",background:T.headerGrad,borderBottom:"1px solid "+T.headerBorder}}>
            <div style={{maxWidth:980,margin:"0 auto"}}>
              ...
              <p style={{color:T.textMuted,fontSize:15,lineHeight:1.55,margin:"12px 0 0",maxWidth:620,fontFamily:"'Newsreader',Georgia,serif"}}>
                A free, always-current guide to upcoming conferences in finance, accounting, and economics, with submission deadlines, dates, locations, rankings, and travel cost estimates, all in one place.
              </p>
              <div style={{display:"flex",gap:22,marginTop:18,flexWrap:"wrap"}}>
                {[{n:counts.total,l:"TOTAL",c:isDark?"#818cf8":"#6366f1"},{n:counts.upcoming,l:"UPCOMING",c:isDark?"#10b981":"#059669"},{n:counts.past,l:"PAST",c:"#6b7280"},{n:counts.soon,l:"\u226460 DAYS",c:counts.soon>0?(isDark?"#f59e0b":"#d97706"):T.textDim},{n:counts.confirmed,l:"DL SET",c:counts.confirmed>0?(isDark?"#34d399":"#059669"):T.textDim},{n:counts.tbd,l:"TBD",c:"#6b7280"},{n:counts.countries,l:"COUNTRIES",c:isDark?"#a78bfa":"#7c3aed"},...(recentlyAdded.length>0?[{n:recentlyAdded.length,l:"NEW TODAY",c:isDark?"#34d399":"#059669"}]:[])].map(s=>(
          ...
          {recentlyAdded.length>0&&(
            <div style={{maxWidth:980,margin:"0 auto",padding:"0 20px 16px"}}>
              <div style={{padding:"16px 18px",borderRadius:10,background:isDark?"rgba(16,185,129,0.06)":"rgba(16,185,129,0.04)",border:"1px solid "+(isDark?"rgba(16,185,129,0.2)":"rgba(16,185,129,0.15)")}}>
                <div onClick={()=>setShowAddedToday(!showAddedToday)} style={{display:"flex",alignItems:"center",gap:8,cursor:"pointer",userSelect:"none"}}>
                  <span style={{fontSize:10,color:T.textDim,transition:"transform 0.2s",transform:showAddedToday?"rotate(90deg)":"rotate(0deg)"}}>▶</span>
                  <span style={{fontSize:14}}>🆕</span>
                  <span style={{fontSize:13,fontWeight:600,color:isDark?"#34d399":"#059669"}}>Added Today</span>
                  <span style={{fontSize:10,color:T.textDim,fontFamily:"'JetBrains Mono',monospace"}}>{recentlyAdded.length} conference{recentlyAdded.length!==1?"s":""}</span>
                </div>
                {showAddedToday&&(<div style={{display:"flex",flexDirection:"column",gap:4,marginTop:10}}>
                  {recentlyAdded.map(c=><Card key={c.id} conf={c} expanded={expandedId===c.id} onToggle={()=>setExpandedId(expandedId===c.id?null:c.id)} sortBy={sortBy} T={T} isDark={isDark} isSelected={comparisonList.includes(c.id)} onCompareToggle={handleCompareToggle} travelData={travelData} />)}
                </div>)}
              </div>
            </div>
          )}
          ...
          {addedThisWeek.length>0&&(
            <div style={{maxWidth:980,margin:"0 auto",padding:"0 20px 16px"}}>
              <div style={{padding:"16px 18px",borderRadius:10,background:isDark?"rgba(59,130,246,0.06)":"rgba(59,130,246,0.04)",border:"1px solid "+(isDark?"rgba(59,130,246,0.2)":"rgba(59,130,246,0.15)")}}>
                <div onClick={()=>setShowAddedThisWeek(!showAddedThisWeek)} style={{display:"flex",alignItems:"center",gap:8,cursor:"pointer",userSelect:"none"}}>
                  <span style={{fontSize:10,color:T.textDim,transition:"transform 0.2s",transform:showAddedThisWeek?"rotate(90deg)":"rotate(0deg)"}}>▶</span>
                  <span style={{fontSize:14}}>📅</span>
                  <span style={{fontSize:13,fontWeight:600,color:isDark?"#60a5fa":"#2563eb"}}>Added This Week</span>
                  <span style={{fontSize:10,color:T.textDim,fontFamily:"'JetBrains Mono',monospace"}}>{addedThisWeek.length} conference{addedThisWeek.length!==1?"s":""}</span>
                </div>
                {showAddedThisWeek&&(<div style={{display:"flex",flexDirection:"column",gap:4,marginTop:10}}>
                  {addedThisWeek.map(c=><Card key={c.id} conf={c} expanded={expandedId===c.id} onToggle={()=>setExpandedId(expandedId===c.id?null:c.id)} sortBy={sortBy} T={T} isDark={isDark} isSelected={comparisonList.includes(c.id)} onCompareToggle={handleCompareToggle} travelData={travelData} />)}
                </div>)}
              </div>
            </div>
          )}
          ...
          <div style={{maxWidth:980,margin:"0 auto",padding:"0 20px 36px"}}>
            ...
            {view==="list"?(
              ...
              <div style={{marginTop:10}}>
                <MapView conferences={filtered} T={T} isDark={isDark} />
                <div style={{marginTop:12,fontSize:11,color:T.textDim,textAlign:"center"}}>
                  Showing {filtered.filter(c=>c.location!=="Virtual"&&c.location!=="TBD"&&getCoords(c.location)).length} mapped conferences.
                  Colors: <span style={{color:"#3b82f6"}}>Finance</span>, <span style={{color:"#10b981"}}>Accounting</span>, <span style={{color:"#f59e0b"}}>Economics</span>, <span style={{color:"#a855f7"}}>Mixed</span>.
                </div>
              </div>
            ):(
              <div style={{marginTop:10}}>
            ...
            {filteredTBD.length>0&&(
              <div style={{marginTop:26}}>
                <div onClick={()=>setShowTBD(!showTBD)} style={{display:"flex",alignItems:"center",gap:8,cursor:"pointer",padding:"10px 14px",borderRadius:8,background:isDark?"rgba(99,102,241,0.06)":"rgba(99,102,241,0.04)",border:"1px solid "+(isDark?"rgba(99,102,241,0.15)":"rgba(99,102,241,0.12)")}}>
                  <span style={{color:T.textDim,fontSize:13,transition:"transform 0.2s",transform:showTBD?"rotate(180deg)":"none"}}>&#9662;</span>
                  <span style={{fontSize:13,fontWeight:600,color:"#6366f1"}}>Conference Dates TBD</span>
                  <span style={{fontSize:10,color:T.textDim,fontFamily:"'JetBrains Mono',monospace"}}>{filteredTBD.length} conferences</span>
                  <div style={{flex:1,height:1,background:T.dividerLight}} />
                </div>
                {showTBD&&(
                  <div style={{marginTop:6,display:"flex",flexDirection:"column",gap:3,opacity:0.8}}>
                    {filteredTBD.map(c=>{
                      const dl=getDeadlineStatus(c.deadline,isDark);
                      return(
                        <div key={"tbd-"+c.id} style={{display:"flex",alignItems:"center",gap:8,padding:"5px 10px",borderRadius:5,background:isDark?"rgba(99,102,241,0.04)":"rgba(99,102,241,0.03)",borderLeft:"2px solid rgba(99,102,241,0.3)"}}>
                          {c.disc.map(d=>{const dd=disc[d];return dd?<span key={d} style={{fontSize:7,color:dd.c,opacity:0.7,fontWeight:700,fontFamily:"'JetBrains Mono',monospace"}}>{dd.l}</span>:null;})}
                          {c.tier&&tiers[c.tier]&&<span style={{fontSize:7,color:tiers[c.tier].c,opacity:0.7,fontWeight:700,fontFamily:"'JetBrains Mono',monospace"}}>{tiers[c.tier].l}</span>}
                          <span style={{fontSize:11.5,color:T.text,flex:1}}>{c.name}</span>
                          <span style={{padding:"1px 5px",borderRadius:3,fontSize:8,color:dl.color,background:dl.bg,fontWeight:600,fontFamily:"'JetBrains Mono',monospace"}}>{dl.label}</span>
                          {c.url&&<a href={c.url} target="_blank" rel="noopener" style={{fontSize:9,color:T.textDim}} onClick={e=>e.stopPropagation()}>🔗</a>}
                        </div>
                      );
                    })}
                  </div>
